...
public class MainActivity extends AppCompatActivity
    ...
    private ImageView abc, dem, soundOn, soundOff, trochoi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        abc= findViewById(R.id.btn_abc);
        dem= findViewById(R.id.btn_123);
        trochoi= findViewById(R.id.btn_trochoi);
        soundOn= findViewById(R.id.sound_on);
        soundOff= findViewById(R.id.sound_off);
        soundOn.setVisibility(View.GONE);


        final MediaPlayer mediaPlayer= MediaPlayer.create(this, R.raw.bg_song);
        ...
        dem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent= new Intent(MainActivity.this,HocDemActivity.class);
                startActivity(intent);
            }
        });
...
//        });
        ...
        tvUserName= header.findViewById(R.id.textView);
